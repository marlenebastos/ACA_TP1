...
-- *****************************************************************************
-- Generated on "11/20/2018 15:47:22"
                                                             
-- Vhdl Test Bench(with test vectors) for design  :          HammingCode
-- 
...
ENTITY HammingCode_vhd_vec_tst IS
END HammingCode_vhd_vec_tst;
ARCHITECTURE HammingCode_arch OF HammingCode_vhd_vec_tst IS
-- constants                                                 
-- signals                                                   
